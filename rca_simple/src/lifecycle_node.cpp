...
public:
        ...
        void msgCallback(const std_msgs::msg::String & msg)
        {
            ...
            {
                RCLCPP_INFO_STREAM(get_logger(),"Lifecycle node hört : " << msg.data.c_str());
            }
...
int main(int argc, char *argv[]){
    ...
    auto sln = std::make_shared<SimpleLifecycleNode>("simple_lifecycle_node");
    ste.add_node(sln->get_node_base_interface());
    ste.spin();
    rclcpp::shutdown();
    return 0;
}